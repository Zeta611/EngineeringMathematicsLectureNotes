...
\begin{proof}
    ...
    우선 $\mathcal B_\cap = \mathcal B_U \cap \mathcal B_W$임을 보이자.\footnote{하지만 $\mathcal B_U \setminus \mathcal B_W$는 $U \setminus W$의 기저가 아니다.
    $\vec 0 \in U \cap W$임에 따라 $\vec 0 \notin U \setminus W$이므로, $U \setminus W$는 벡터 공간이 아니기 때문이다.}
